...
const featuredWorks = [
  {
    title: "Aarde",
    artist: "Stasja van Grootheest",
    city: "Harderwijk",
    image: aardeImg,
  },
  {
    title: "Bakje rode duiven",
    artist: "Miranda Adam",
    city: "Ermelo",
    image: duivenImg,
  },
    ...
    <div className="home-page">
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <p>
            Ontdek de ateliers, ontmoet de kunstenaars en laat je inspireren
            door de kunst op de Veluwe.
          </p>
          <div className="hero-actions">
            <button className="btn-primary"> Bekijk de route</button>
            <button className="btn-secondary"> Ontdek kunstwerken</button>
          </div>
        </div>
      </section>
      ...
      <section className="history-section">
        ...
        <p className="history-text">
          Sinds het begin van de jaren 2000 brengt de Kunstroute Noordwest
          Veluwe kunst buiten de museummuren. Wat begon als een klein initiatief
          van enthousiaste kunstenaars is uitgegroeid tot een geliefd jaarlijks
          evenement met meer dan 25 deelnemers. Elk jaar openen professionele
          kunstenaars hun ateliers in Elspeet, Ermelo, Harderwijk, Hulshorst,
          Nunspeet, Oldebroek en Speuld voor het publiek.
        </p>
      </section>
      ...
      <footer className="site-footer">
        <div className="color-strip footer-strip">
          <span className="green" />
          <span className="yellow" />
          <span className="pink" />
          <span className="purple" />
        ...
        <div className="footer-content">
          <div className="footer-col">
            <a href="/" className="footer-logo" aria-label="Kunstroute Noordwest Veluwe">
              <img src={logoImg} alt="Kunstroute Noordwest Veluwe" className="footer-logo-img" />
            </a>
            <p>
              Ontdek de verborgen parels van de Veluwe. Bezoek ateliers en
              kunstenaars in hun creatieve omgeving.
            </p>
          </div>
          <div className="footer-col">
            <h4>Snel naar</h4>
        ...
        <div className="footer-bottom">
          © 2026 Stichting Kunstroute NW-Veluwe
        </div>
      </footer>
    </div>
  );
