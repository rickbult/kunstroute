...
export default function Registreren() {
  ...
  function handleSubmit(e) {
    ...
    const verplicht = ['voornaam', 'achternaam', 'email', 'wachtwoord', 'telefoon', 'kunstrichting', 'adres', 'postcode', 'woonplaats'];
    ...
    const { wachtwoordBevestig, voorwaarden, ...userData } = form;
        ...
        <form onSubmit={handleSubmit} className="reg-form" noValidate>
          ...
          <section className="reg-section">
            ...
            <p className="reg-info">
              Doe je voor het eerst mee of heb je in 2022 of eerder voor het laatst meegedaan aan de kunstroute,
              dan vindt er een ballotage plaats. Vul dan hieronder het adres in waar we jou kunnen balloteren:
            </p>
          ...
          <p className="reg-info">P.S. De voorwaarden worden als bijlage in de mail meegestuurd.</p>

          <div className="reg-submit-row">
            <button type="submit" className="reg-btn">Verzenden</button>
            <button
              type="button"
